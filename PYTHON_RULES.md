...
This project follows a strict set of rules for development. Principles for the overall system architecture, file structure, testing guidelines, and style rules must be followed closely.
